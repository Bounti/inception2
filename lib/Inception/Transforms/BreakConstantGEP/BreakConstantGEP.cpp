...
//===- BreakConstantGEP.cpp - Change constant GEPs into GEP instructions - --//
//
...
char BreakConstantGEP::ID = 0;

// Register the pass
static RegisterPass<BreakConstantGEP> P("break-constgeps",
                                         "Remove GEP Constant Expressions");

FunctionPass *llvm::createBreakConstantGEPPass() {
  return new BreakConstantGEP();
}
...
//
bool BreakConstantGEP::runOnFunction(Function &F) {
  bool modified = false;
