...
#include "inception/CodeInv/MCDirector.h"
...
MCDirector::MCDirector(std::string TripleName,
  ...
  klee::klee_message("Using Triple: %s", TripleName.c_str());
  klee::klee_message("Using CPU: %s", CPUName.str().c_str());
  klee::klee_message("Using Features: %s", Features.str().c_str());
