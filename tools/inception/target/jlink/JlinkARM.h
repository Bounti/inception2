...
void JLINKARM_SelectDeviceFamily(char* str);
// JLINKARM_GetScanLen
...
// JLINKARM_ReadICEReg
//JLRESULT JLINKAPI JLINK_ReadMemU32(unsigned zone, unsigned addr, unsigned len, void* buf);
JLRESULT JLINKAPI JLINKARM_ReadMem(unsigned addr, unsigned num_bytes, char* data, void *status);
...
// JLINK_EnableLogCom
// JLINK_EnableSoftBPs
extern void JLINK_ExecCommand(char* cmd, char* buf, int size);
// JLINK_FindBP
...
// JLINK_SelDevice
// JLINK_SelectIP
extern void JLINK_SelectUSB(int);
// JLINK_SetBP
// JLINK_SetBPEx
// JLINK_SetEndian
