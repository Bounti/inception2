...
void FunctionsHelperWriter::FNHInterruptEpilogue(llvm::Module* mod,
  ...
  if (function == NULL) {
    klee::klee_warning("Cannot write inception_interrupt_epilogue");
    return;
  }

  klee::klee_message("Writing inception_interrupt_epilogue");
...
void FunctionsHelperWriter::FNHInterruptPrologue(llvm::Module* mod,
  ...
  Function* function = cast<Function>(func_ptr);
  if (function == NULL) {
    klee::klee_warning("Cannot write inception_interrupt_prologue");
    return;
  }

  klee::klee_message("Writing inception_interrupt_prologue");
...
void FunctionsHelperWriter::FNHICP(llvm::Module* mod, llvm::Instruction* inst) {
  ...
  Function* function = cast<Function>(func_ptr);
  if (function == NULL) {
    klee::klee_warning("Cannot write inception_icp");
    return;
  }

  klee::klee_message("Writing inception_icp");
  ...
  Constant* const_ptr = GetVoidFunctionPointer("klee::klee_warning");
...
void FunctionsHelperWriter::FNHInterruptHandler(llvm::Module* mod,
  ...
  Function* function = cast<Function>(func_ptr);
  if (function == NULL) {
    klee::klee_warning("Cannot write inception_interrupt_handler");
    return;
  }

  klee::klee_message("Writing inception_interrupt_handler");
...
void FunctionsHelperWriter::FNHSwitchSP(llvm::Module* mod,
  ...
  Function* function = cast<Function>(func_ptr);
  if (function == NULL) {
    klee::klee_warning("Cannot write inception_switch_sp");
    return;
  }

  klee::klee_message("Writing inception_switch_sp");
...
void FunctionsHelperWriter::FNHWritebackSP(llvm::Module* mod,
  ...
  Function* function = cast<Function>(func_ptr);
  if (function == NULL) {
    klee::klee_warning("Cannot write inception_writeback_sp");
    return;
  }

  klee::klee_message("Writing inception_writeback_sp");
...
void FunctionsHelperWriter::FNHCacheSP(llvm::Module* mod,
  ...
  Function* function = cast<Function>(func_ptr);
  if (function == NULL) {
    klee::klee_warning("Cannot write inception_cache_sp");
    return;
  }

  klee::klee_message("Writing inception_cache_sp");
